...
import ClientsStoriesSection from "../Home/sections/ClientsStoriesSection.vue";
import FAQSection from "../Home/sections/FAQSection.vue";
import GetInTouchSection from "../Home/sections/GetInTouchSection.vue";
import AchievementsSection from "../Services/sections/AchievementsSection.vue";
const faqs = [
  {
...
<template>
  <PagesBanner title="HOST NETWORK" />
  <AchievementsSection />

  <img
    src="/src/assets/img/hostNetwork/hn-2.svg"
    alt="Our Team Image"
    class="w-full h-auto"
  />
  <ClientsStoriesSection variant="blue" />
