...
<template>
  <article
    class="flex blog-card bg-white cursor-pointer transition-all duration-300"
    @mouseenter="isHovered = true"
    @mouseleave="isHovered = false"
    @click="goToBlog"
  >
    <!-- Image -->
    <div class="overflow-hidden w-[170px] h-auto flex-shrink-0">
      <img
        :src="blog.image"
        alt=""
    ...
    <!-- Content -->
    <div class="px-5 py-4">
      <div class="flex items-left gap-4 mb-[18px] text-sm">
      ...
      <div class="text-base text-gray-500 leading-relaxed mt-1">
        {{ blog.description }}
      </div>
    </div>
  </article>
